...
var style_2019GEEstimate_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_2019GEEstimate_12(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_2019GEEstimate_12rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_2019GEEstimate_12rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_2019GEEstimate_12(feature, value);
        ;
